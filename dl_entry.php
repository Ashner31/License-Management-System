				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.html">RTO <span>CMRIT</span></a></h1>
							</div>
						</div>
...
mysqli_select_db($conn,"dbms_p1");
					...
					$sql1="select llr_issue_date,llr_status,llr_id,cov from llr where aadhar=$aad order by llr_id desc limit 1" ;
					...
					else
					{
						...
						$sql="INSERT INTO dl(aadhar,name,cov,edate,eid,dl_id,passwd,mail_id) VALUES('$aad','$name','$q1','$d','$eid','$x','$passwd','$mail_id')";
